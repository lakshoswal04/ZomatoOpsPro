    ...
    <div className="container mx-auto px-4 py-8 dark:bg-gray-900 min-h-screen">
      <div className="flex justify-between items-center mb-6 dark:border-b dark:border-gray-700 pb-4">
        ...
        <div className="flex items-center space-x-4">
          <Link to="/manager" className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-white px-4 py-2 rounded-lg transition duration-200 flex items-center font-medium shadow-sm dark:shadow-gray-900/20 border border-transparent dark:border-gray-600">
